...
function getCashIn() {
  ...
  if (cashIn.length) {
    ...
    for (let index = 0; index < limit; index++) {
      cashInHtml += `<div class="row mb-4" id="list-in">
        ...
        <div class="container p-0">
          <div class="row">
            ...
            <div class="fs-2 delete">
              <button class="btn button-delete delete">
...
function getCashOut() {
  ...
  if (cashOut.length) {
    ...
    for (let index = 0; index < limit; index++) {
      cashOutHtml += `<div class="row mb-4" id="list-out">
      <div class="col-12 list-item">
...
function removeTransaction() {
  ...
  listIn.addEventListener("click", (e) => {
  ...
  listOut.addEventListener("click", (e) => {
    if (!e.target.matches(".delete")) return;
